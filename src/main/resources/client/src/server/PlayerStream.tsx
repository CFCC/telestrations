...
const PictureContainer = styled.div`
  background-image: ${(props: PictureContainerProps) =>
    props.picture === "/question-marks.jpg"
      ? "url(/question-marks.jpg)"
      : "none"};
  background-repeat: repeat;
  width: 100%;
  min-height: ${(props: PictureContainerProps) =>
    props.picture === "/question-marks.jpg" ? "300px" : "0"};
`;
  ...
  return (
    <React.Fragment>
      <PictureContainer picture={picture}>
        {picture !== "/question-marks.jpg" && (
          <Picture src={pictureUrl} alt={text} />
        )}
      </PictureContainer>
      <Content>
